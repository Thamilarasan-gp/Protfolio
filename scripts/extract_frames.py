...
def main():
    video_path = r"C:\Freelancing\Protfolio\lib\video\i_need_sections_ok_from_top (1).mp4"
    output_dir = r"C:\Freelancing\Protfolio\public\frames"
    ...
    print(f"Reading source video: {video_path}")
    ...
    print(f"Loaded {source_count} source frames. Generating {target_count} target frames...")

    total_bytes = 0

    for k in range(target_count):
        # Linear interpolation parameter t between 0 and source_count - 1
        ...
        frame_filename = f"frame_{k:03d}.webp"
    ...
    manifest = {
        ...
        "quality": quality,
        "chunks": [
            { "chunkIndex": 1, "name": "Hero", "start": 0, "end": 59, "count": 60 },
            { "chunkIndex": 2, "name": "About", "start": 60, "end": 119, "count": 60 },
            { "chunkIndex": 3, "name": "Skills", "start": 120, "end": 179, "count": 60 },
            { "chunkIndex": 4, "name": "Projects", "start": 180, "end": 239, "count": 60 },
            { "chunkIndex": 5, "name": "Journey", "start": 240, "end": 299, "count": 60 },
            { "chunkIndex": 6, "name": "Contact", "start": 300, "end": 359, "count": 60 }
        ],
    ...
    print("=" * 50)
    print("EXTRACTION COMPLETE REPORT:")
